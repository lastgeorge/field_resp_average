...
void test(){
  ...
  // Do convolution 
  // TH1F *hw = new TH1F("hw","hw",2000,-60,40);
  TH1F *her = new TH1F("her","her",2000,0,100);
  
  TH1F **hu = new TH1F*[11];
  TH1F **hv = new TH1F*[11];
  TH1F **hw = new TH1F*[11];
  for (Int_t i=0;i!=11;i++){
    hu[i] = new TH1F(Form("hu_%d",i),Form("hu_%d",i),2000,-60,40);
    hv[i] = new TH1F(Form("hv_%d",i),Form("hv_%d",i),2000,-60,40);
    hw[i] = new TH1F(Form("hw_%d",i),Form("hw_%d",i),2000,-60,40);
  }
  ...
  Double_t value_re[2000];
  Double_t value_im[2000];
  TH1 *fb = 0;
  TH1 *hm = 0;
  TH1 *hp = 0;
  ...
  TFile *file1 = new TFile("ave_res_test.root","RECREATE");
  for (Int_t i=0;i!=11;i++){
